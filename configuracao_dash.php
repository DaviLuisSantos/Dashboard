                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="editarModalLabel_<?php echo $grafico->id; ?>">Editar Gráfico - <?php echo $grafico->nome; ?></h5>
                        ...
                        <div class="modal-body">
                            ...
                            <form action="processar_edicao.php" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="ordem_exib_<?php echo $grafico->id; ?>">Ordem de Exibição:</label>
                                ...
                                <div class="form-group">
                                    <label for="tempo_refresh_<?php echo $grafico->id; ?>">Tempo de Atualização
                                        (segundos):</label>
                                    <input type="number" id="tempo_refresh_<?php echo $grafico->id; ?>" name="tempo_refresh"
                                        value="<?php echo $grafico->tempo_refresh; ?>" required class="form-control">
                                </div>
                                <div class="form-group">
    <label for="type_<?php echo $grafico->id; ?>">Tipo de Gráfico:</label>
    <select id="type_<?php echo $grafico->id; ?>" name="type" class="form-control" required>
        <?php
