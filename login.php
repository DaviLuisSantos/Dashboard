                ...
                <div class="form">
                  <div id="username-field" class="field-wrapper input">
                      ...
                      <select id="username"  name="login" class="form-control" name="tipovisitante">
                        ...
                        <?php             
                            $sqlUsuarios = "SELECT LOGIN, NOME FROM OPERADOR_SISTEMA WHERE USOADMTOTAL='1' OR USOLINEAR='1'";
                  ...
                  <div id="password-field" class="field-wrapper input mb-2">
                    <input id="password" name="senha" type="password" class="form-control" placeholder="senha" autocomplete="off">
                  </div>
